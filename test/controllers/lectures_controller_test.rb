...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { classroom_id: @lecture.classroom_id, number: @lecture.number, teacher_id: @lecture.teacher_id } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { classroom_id: @lecture.classroom_id, number: @lecture.number, teacher_id: @lecture.teacher_id } }
